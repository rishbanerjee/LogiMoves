...
const Reliable = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <div>
        <svg {...props}  version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
